...
Researchers in the field of mobility detection using WiFi-CSI have discussed the lack of support for signal processing/analysis and visualization methods in conventional CSI toolkits. To address this issue, we create **newly_csi_analyzer.m**, a function designed for amplitude and phase calculation, as well as signal processing of acquired CSI samples. This function is executable in both MATLAB and GNU Octave. Additionally, we have included a process for decomposing the amplitude and phase characteristics inherent in complex numbers($a+bi$) on WiFi-CSI. The visualization code incorporates advanced signal processing techniques, such as phase unwrapping filters, uniform fitting, median filtering, and linear-regression fitting, enabling more accurate and insightful analysis. Herein, I referred to novel approaches [DensePose From WiFi](https://arxiv.org/abs/2301.00250) and [Can WiFi Estimate Person Pose?](https://arxiv.org/abs/1904.00277).
