...
- Collected synchronized CSI + camera data using this toolkit.
- Teacher Network: designed, trained, evaluated on this dataset.
- Student Network: trained to mimic Teacher outputs using the collected dataset.
